    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            <div class="pull-left">
                ...
                <span class="title">xForm / Создать форму</span>
            </div>
            <div class="pull-right">
                <div class="d-i_b">
                    <a href="/admin/components/cp/xform/" class="t-d_n m-r_15"><span class="f-s_14">←</span> <span class="t-d_u">Венуться</span></a>
                    <button type="button" class="btn btn-small btn-primary formSubmit" data-form="#save" data-submit><i class="icon-ok icon-white"></i>Создать</button>
                </div>
            </div>                            
        </div>               
                            ...
                            <td colspan="6">
                                <div class="inside_padd span9">
                                    <div class="form-horizontal">
                                        <form id="save" method="post" action="{site_url('admin/components/cp/xform/create_form')}">
                                            <div class="control-group">
                                                <label class="control-label" for="page_title">Название</label>
                                                <div class="controls">
                                                    <input type="text" class="textbox_long" name="page_title" id="page_title_u" value="" require>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="desc" class="elRTE required" name="desc" rows="10" cols="180" ></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="good" class="elRTE required" name="good" rows="10" cols="180" ></textarea>
                                                </div>
                                            </div>
